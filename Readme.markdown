...
Before running ./oebb.sh update, append the following line to oe/sources/layers.txt:
	meta-kipr,git://github.com/kipr/meta-kipr,master,HEAD
	
Follow the remaining steps, but replace:
	bitbake kovan-bringup-image

With:
	bitbake kovan-distribution-image
